...
plot data_folder.'length-rural-30-1000-data.gnuplot' i 0 u 1:2 w boxes lc rgb "#00FF0000" title '',\
     data_folder.'length-suburban-30-1000-data.gnuplot' i 0  u 1:2 w boxes lc rgb "#000000FF" title '',\
     data_folder.'length-urban-30-1000-data.gnuplot' i 0 u 1:2 w boxes lc rgb "#0000FF00" title '',\
     data_folder.'length-rural-30-1000-data.gnuplot' i 1 u 1:2 w lines title "Rural Areas" lc "red" lw 4, \
     data_folder.'length-suburban-30-1000-data.gnuplot' i 1 u 1:2 w lines title "Suburban Areas" lc "blue" lw 4,\
     data_folder.'length-urban-30-1000-data.gnuplot' i 1 u 1:2 w lines title "Urban Areas" lc "green" lw 4, \
